#parse a file and return the lines which have number 
#Input
#ls -la
#4
#lo poll
...
def parser(filename):
  ...
  try:
    ...
    while i < num_lines:
        ...
        #print (type(line)) #-> checking each line type() that was read in lines variable above,whether it's an integer or string remove # before print, ypu might notice even a number from a file is read as string
